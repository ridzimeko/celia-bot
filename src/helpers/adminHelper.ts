...
const botCanRestrictUser = checkBotPermission(
  'can_restrict_members',
  'Maaf, aku tidak punya izin untuk membatasi anggota',
);

// Promote members middleware
const botCanPromoteUser = checkBotPermission(
  'can_promote_members',
  'Maaf, aku tidak punya izin untuk mempromosikan anggota',
);

// Pin chat message middleware
const botCanPinMessage = checkBotPermission(
  'can_pin_messages',
  'Maaf, aku tidak punya izin untuk menyematkan pesan',
);
